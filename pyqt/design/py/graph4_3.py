...
# Form implementation generated from reading ui file 'c:\Users\artem\Desktop\graph\.venv\pyqt\design\UI\graph4_3.ui'
#
...
"}")
        ...
        self.mdiArea = QtWidgets.QMdiArea(self.First_Page)
        self.mdiArea.setObjectName("mdiArea")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.SpanningRole, self.mdiArea)
        ...
        self.mdiArea_2 = QtWidgets.QMdiArea(self.Second_Page)
        self.mdiArea_2.setObjectName("mdiArea_2")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.mdiArea_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.FP_VL1_PushButton.setText(_translate("MainWindow", "<<< Graph Algorithm"))
        self.FP_VP3_CheckGraphBtn.setText(_translate("MainWindow", "Check graph"))
        self.FP_VP3_GreatGraphExampleBtn.setText(_translate("MainWindow", "Great graph example"))
        self.label.setText(_translate("MainWindow", "Graph size"))
        self.pushButton_2.setText(_translate("MainWindow", "+"))
        self.pushButton.setText(_translate("MainWindow", "-"))
        self.pushButton_3.setText(_translate("MainWindow", "Clear graph map"))
        self.pushButton_4.setText(_translate("MainWindow", "Delete graph"))
        self.FP_VP2_LineEdit.setPlaceholderText(_translate("MainWindow", "Название элемента графа"))
        self.FP_VP2_PushButton.setText(_translate("MainWindow", "Create graph element"))
        ...
        self.VP_UploadGraphButton.setText(_translate("MainWindow", "Load graph (*.json)"))
        self.VP_PushButton1.setText(_translate("MainWindow", "Your graphs"))
